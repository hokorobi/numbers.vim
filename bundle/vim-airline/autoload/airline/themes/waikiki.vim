...
let g:airline#themes#waikiki#palette.normal_modified = {
      \ 'airline_c': [ '#66D9EF' , '#21252B' , 81 , 16 , '' ] ,
      \ }

" Insert mode
let s:I1 = [ '#181B20' , '#A6E22E' , 232 , 118 ]
...
let g:airline#themes#waikiki#palette.visual_modified = {
      \ 'airline_c': [ '#FD971F' , '#21252B' , 208 , 16 , '' ] ,
      \ }
