...
" Date: 2017-02-01
" License: GPL
" Note: Based on WWDC16 theme from Apple
...
let s:bgorange = color#HSLtoHex(color#HexToHSL(s:red   )[0], s:uis, s:uil.dark)
...
call s:SetColor("Search", s:bgpalette[4], s:red)
...
call s:SetColor("WarningMsg", s:red, s:bgpalette[2], "bold")
...
call s:SetColor("DiffText", s:red, s:bgyellow)
...
call s:SetFgColor("Identifier", s:red)
" Statement
...
call s:SetFgColor("PreCondit", s:red, "bold")
call s:SetFgColor("PreProc", s:red)
" Type
...
" Special
call s:SetFgColor("Delimiter", s:red, "bold")
